...
print("DEBUG >> OPENAI_API_KEY starts with:", OPENAI_API_KEY[:8] if OPENAI_API_KEY else "EMPTY")
...
# --- Load config.json (optional fallback, but don't overwrite env) ---
...
# Custom system instruction for more natural replies
ai = AIHelper(openai_api_key=OPENAI_API_KEY)
ai.system_prompt = (
    "You are Butki 🤖, a friendly and funny Telegram chatbot. "
    "Reply short, natural, playful, and sometimes emotional like a real friend. "
    "Use emojis and casual style in groups."
)
...
def sticker(msg: types.Message):
    ...
    try:
        stickers = [
            "CAACAgUAAxkBAAEBQF5l3...",  # sample sticker id
