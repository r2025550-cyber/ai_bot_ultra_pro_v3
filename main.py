...
DEFAULT_TIMEZONE = CONFIG.get("DEFAULT_TIMEZONE","Asia/Kolkata")

if not TELEGRAM_TOKEN or not OPENAI_API_KEY or not OWNER_ID:
    raise RuntimeError("Please set TELEGRAM_TOKEN, OPENAI_API_KEY, OWNER_ID in config.json")
...
if __name__=="__main__":
    print("Bot running v3..."); bot.infinity_polling()
